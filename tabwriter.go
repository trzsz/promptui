...
// Package promptui implements a write filter (tabwriter.Writer) that
...
var vt100Regexp = regexp.MustCompile(`\x1b\[[0-9;]*[a-zA-Z]`)

func (b *Writer) runeWidth(p []byte) int {
	text := vt100Regexp.ReplaceAll(p, []byte(""))
	return runewidth.StringWidth(string(text))
}

// Update the cell width.
func (b *Writer) updateWidth() {
	b.cell.width += b.runeWidth(b.buf[b.pos:])
	b.pos = len(b.buf)
}
